            ...
            <div className="flex items-center mt-10 space-x-4">
              ...
              <div className="flex items-center space-x-2 text-amber-800">
                <div className="flex -space-x-2">
                  {[1, 2, 3].map((i) => (
                    <div key={i} className="w-10 h-10 rounded-full bg-amber-200 border-2 border-white flex items-center justify-center text-amber-800 font-bold text-xs hover:scale-110 transition-transform duration-300">
                      TD
                    </div>
                  ))}
                </div>
