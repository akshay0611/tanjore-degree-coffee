...
export default function HeroSection() {
  ...
  return (
    <section className="relative h-[90vh] flex items-center justify-center overflow-hidden">
      ...
      >
        <div className="w-full h-full bg-gradient-to-b from-amber-950 via-amber-900 to-amber-950">
      ...
      <div className="container relative z-10 px-4 mx-auto text-center">
        ...
        <h1 className="text-4xl font-bold tracking-tight text-white sm:text-5xl md:text-6xl lg:text-7xl mb-2 drop-shadow-[0_2px_4px_rgba(0,0,0,0.3)]">
          <span className="text-amber-400">Tanjore</span> Degree Coffee
        </h1>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mt-12">
          ...
          <Button
            size="lg"
            variant="outline"
            className="text-amber-200 border-amber-400 hover:bg-amber-900/40 px-8 py-6 text-lg rounded-full transition-all duration-300 hover:scale-105 backdrop-blur-sm"
          >
            Our Story
          </Button>
        </div>
