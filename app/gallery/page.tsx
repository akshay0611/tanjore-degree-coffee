          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {images.map((src, index) => {
              ...
              return (
                <div
                  key={index}
                  className={`group relative overflow-hidden rounded-xl shadow-md hover:shadow-xl transition-all duration-300 ${isFeatured ? 'col-span-2 row-span-2' : ''
                    }`}
                  onClick={() => openModal(src, index)}
                >
                  <Image
                    src={src}
                    alt={`Tanjore Degree Coffee gallery image ${index + 1} - FoodTech project by Akshay Kumar`}
              ...
              >
                <div className="relative h-64 overflow-hidden">
                  <Image
                    ...
                    alt={`${collection.title} - Coffee Collection by Akshay Kumar`}
                    width={500}
                    height={300}
                    className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
                  />
            ...
            {[
              ...
              >
                <div className="relative aspect-video overflow-hidden">
                  ...
                  <Image
                    src={video.image}
                    alt={`${video.title} - Coffee Journey by Akshay Kumar`}
                    width={600}
                    height={400}
                    className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
                  />
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
            {[
              ...
              >
                <Image
                  src={src}
                  alt={`Instagram post ${index + 1} - Tanjore Degree Coffee lifestyle by Akshay Kumar`}
                  width={300}
                  height={300}
                  className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
                />
